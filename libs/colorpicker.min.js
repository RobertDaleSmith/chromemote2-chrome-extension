...
var initColorPicker = function(){
    ...
    function (hex, hsv, rgb) {
        ...
        if(borderColorsEnabled){
            ...
            $(".remote_button:not(.remote_button_no_border)").css("border-top-color", "rgba(" + red + ", " + green + ", " + green + ", 0.750)");
            $('.remote_button').css("border-left-color", "rgba(" + red + ", " + green + ", " + green + ", 0.750)");

            

            $('.remote_button_rocker').css("border-top-color", "rgba(" + red + ", " + green + ", " + green + ", 0.750)");
            $('.remote_button_rocker').css("border-left-color", "rgba(" + red + ", " + green + ", " + green + ", 0.750)");

            $('#remote_touch_pad').css("border-top-color", "rgba(" + red + ", " + green + ", " + green + ", 0.750)");
        }
