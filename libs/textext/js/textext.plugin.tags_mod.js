    ...
    */
    p.addTags = function (tags) {
        ...
        for (i = 0; i < tags.length; i++) {
            ...
            ////
            ////    Changed to compensate for a bug that would not allow tags 
            ////  to be programmatically added while filter plugin is enabled.
            ////
            //if (tag && self.isTagAllowed(tag))      <--original line
            ////
            ////
            if ((tag && self.isTagAllowed(tag)) || (tag && preloadingTags))
